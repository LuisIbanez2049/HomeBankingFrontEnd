...
function CardDebitCredit(props) {
  return (
    <div>
      ...
      */}
      <div id={props.backGroundCard} className='w-[480px] h-[290px] flex flex-row justify-center items-center rounded-[30px] my-[20px]'>  {/* pasar por parametro la id ------------------*/}
        <div id='subcontainerAll' className='w-[92%] h-[88%] relative z-20 p-[4px]'>
          ...
          <div className='w-full flex flex-row justify-between'>
            ...
            <h1><Text3D textSize="text-[22px]" title={props.cvv}/></h1> {/* pasar por parametro el titulo NUMERO DE 3 DIGITOS------------------*/}
          </div>
        </div>
