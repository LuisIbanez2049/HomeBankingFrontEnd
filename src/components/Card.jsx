...
function Card(props) {
  return (
    <div id="containerAttributes" className="w-[480px] h-[232px] text-[26px] text-black font-semibold flex flex-row justify-center items-center my-[20px] rounded-[20px]">
        <div>
